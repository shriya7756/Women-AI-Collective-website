...
export default function Home() {
  ...
  // useEffect removed to avoid synchronous setState inside effect
  ...
  return (
    <section className="relative min-h-screen bg-[#05061a] text-white px-6 py-20 overflow-hidden">
      ...
      <div className={` ${indie.className} max-w-7xl font-indie mx-auto grid grid-cols-1 md:grid-cols-3 gap-x-10 gap-y-14`}>
        {/* Left column */}
...
const stickerPositionClasses = {
  ...
  star: "absolute bottom-8 right-4 w-14 h-14",
